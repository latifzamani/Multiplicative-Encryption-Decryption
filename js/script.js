...
const btnchM = document.querySelector('#changeM');
btnchM.addEventListener('click', function () {
...
const btnchMD = document.querySelector('#changeMD');
btnchMD.addEventListener('click', function () {
